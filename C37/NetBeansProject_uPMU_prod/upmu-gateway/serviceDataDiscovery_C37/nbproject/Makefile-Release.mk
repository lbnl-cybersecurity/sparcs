...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libserviceDataDiscovery_C37.${CND_DLIB_EXT}: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/libserviceDataDiscovery_C37.${CND_DLIB_EXT} ${OBJECTFILES} ${LDLIBSOPTIONS} -shared -fPIC
...
${OBJECTDIR}/C37_Buffer.o: C37_Buffer.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C37_Buffer.o C37_Buffer.cpp

${OBJECTDIR}/C37_CfgDescriptor.o: C37_CfgDescriptor.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C37_CfgDescriptor.o C37_CfgDescriptor.cpp

${OBJECTDIR}/C37_DataChannel.o: C37_DataChannel.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C37_DataChannel.o C37_DataChannel.cpp

${OBJECTDIR}/C37_Reformat.o: C37_Reformat.cpp 
	${MKDIR} -p ${OBJECTDIR}
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -fPIC  -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C37_Reformat.o C37_Reformat.cpp
...
${OBJECTDIR}/C37_Buffer_nomain.o: ${OBJECTDIR}/C37_Buffer.o C37_Buffer.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C37_Buffer_nomain.o C37_Buffer.cpp;\
	else  \
...
${OBJECTDIR}/C37_CfgDescriptor_nomain.o: ${OBJECTDIR}/C37_CfgDescriptor.o C37_CfgDescriptor.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C37_CfgDescriptor_nomain.o C37_CfgDescriptor.cpp;\
	else  \
...
${OBJECTDIR}/C37_DataChannel_nomain.o: ${OBJECTDIR}/C37_DataChannel.o C37_DataChannel.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C37_DataChannel_nomain.o C37_DataChannel.cpp;\
	else  \
...
${OBJECTDIR}/C37_Reformat_nomain.o: ${OBJECTDIR}/C37_Reformat.o C37_Reformat.cpp 
	...
	then  \
	    ${RM} "$@.d";\
	    $(COMPILE.cc) -O2 -fPIC  -Dmain=__nomain -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/C37_Reformat_nomain.o C37_Reformat.cpp;\
	else  \
