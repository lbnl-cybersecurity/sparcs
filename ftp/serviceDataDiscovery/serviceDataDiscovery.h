...
#define DEFAULT_STARTING_YEAR 2018
#define DEFAULT_STARTING_MONTH 7
#define DEFAULT_STARTING_DAY 5
#define DEFAULT_STARTING_HOUR 22
...
#define SCAN_MODE_CATCH_UP_DELAY_SEC 7
...
private:
    ...
    int getCurrentDataFileSet();
    int addDataFile2DB(upmuFtpAccess *, std::string, const std::string&);
    int processUPMUdata();
    void postProcessUPMUdata(unsigned char *, unsigned int);
    void swapBytesUint(unsigned int *);
    void addCurrentDirectoryRecord();
    bool dataFileComplete(std::string *);
